...
//               <div className="overflow-auto absolute z-10 mt-1 w-full max-h-60 bg-white rounded border border-gray-300 shadow-lg">
...
//                 <div className="p-2 cursor-pointer hover:bg-purple-100" onClick={handleAddCustomInterest}>
//                   Add "{inputValue}"
//                 </div>
//               </div>
//             )}
...
//         {/* Success message */}
//         {success && (
//           <Alert className="text-green-600 bg-green-50 border-green-200">
...
// // Dummy skill list (you can import or expand this)
...
//       !fieldOfInterest.includes(getStandardizedField(skill))
//     )
//     .slice(0, 5);
...
//               onBlur={() => setTimeout(() => setIsInputFocused(false), 150)} // small delay to allow click
//               onChange={(e) => setInputValue(e.target.value)}
//               onKeyDown={(e) => {
//                 if (e.key === 'Enter') {
//                   e.preventDefault();
...
//             <ul className="overflow-y-auto absolute z-10 mt-1 w-full max-h-48 bg-white rounded-md border shadow">
