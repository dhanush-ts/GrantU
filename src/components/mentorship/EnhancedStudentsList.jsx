...
import FieldOfInterestSelector from "@/constants/FieldOfInterestSelector" // Import the component
...
const EnhancedStudentsList = ({ userData, act }) => {
  ...
  const [requestData, setRequestData] = useState({
    description: "",
    details: "",
    interests: [], // Changed from string to array
  })
  ...
  const sendRequest = async () => {
    try {
      ...
      const payload = {
        ...
        Interests: requestData.interests, // Now already an array
      }
      ...
      setRequestData({ description: "", details: "", interests: [] }) // Reset to empty array
      fetchStudents()
    } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-purple-200 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Replace the interests input with FieldOfInterestSelector */}
              <div className="relative">
                <FieldOfInterestSelector
                  ...
                  inputClassName="w-full p-3 border-2 border-gray-200 rounded-xl focus:border-purple-400 focus:outline-none transition-colors duration-200"
                  buttonClassName="rounded-r-xl px-4 py-3 h-13"
                  dropdownClassName="border-2 border-gray-200 rounded-xl shadow-lg"
                  labelClassName="text-sm font-semibold mb-2 text-gray-700"
                  badgeClassName="px-3 py-1 rounded-full"
                />
              </div>
